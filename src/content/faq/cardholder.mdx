...
- For more information on the policies listed above, visit the [Policies and Legislation page](https://smartpay.gsa.gov/content/policies).
...
In some cases, when using certain types of accounts, account holders are exempt from taxes on their purchases.  Please visit the [SmartTax](/smarttax/) section of the program website for more information on taxes.  
