...
<div class="grid-container">
  <div class="grid-row">
    <div class="tablet:grid-col">
        <img src="/images/red-card.svg" alt="Red charge card with the word Purchase and numbers 1234 5678 9012 3456 and the name John Smith, with a bird in the background"/>
    </div>
    <div class="tablet:grid-col"> 
    <img src="/images/blue-card.svg" 
  ...
  <div class="grid-row">
    <div class="tablet:grid-col"><img src="/images/green-card.svg" alt="Green charge card with the word Fleet and numbers 1234 5678 9012 3456 and the name John Smith, with a road in the background"/></div>
    <div class="tablet:grid-col"><img src="/images/yellow-card.svg" alt="Yellow charge card with the word Intergrated and numbers 1234 5678 9012 3456 and the name John Smith, with a globe outline in the background"/></div>
  </div>
  <div class="grid-row">
    <div class="tablet:grid-col"><img src="/images/silver-card.svg" alt="Silver charge card with the words Tax advantage and numbers 1234 5678 9012 3456 and the name John Smith, with a car and buildings in the background" /></div>
