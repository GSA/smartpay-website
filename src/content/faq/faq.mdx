...
In some cases, when using certain types of cards/accounts, card/account holders are exempt from taxes on their purchases. Please visit the [State Tax Information](/smarttax/state-tax-forms) section of the program website to learn more.
...
In some cases, certain purchases made using a GSA SmartPay card/account are exempt from taxes. Please visit the [State Tax Information](/smarttax/state-tax-forms) section of the program website for more details.
</Accordion>
