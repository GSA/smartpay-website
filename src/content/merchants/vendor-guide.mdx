---
title: "The GSA SmartPay® Vendor Guide"
...
Purchase Card Integrated Card
Travel Card Fleet Card
Tax Advantage Card
...
## What Are the Best Practices for Assessing Taxes on Purchase Accounts?
 ...
 - If you are unsure of when to assess taxes, please visit https://smartpay.gsa.gov/smarttax for more information, including points of contact for each state.
...
Each state determines the tax exemption status for federal travelers. Before assessing taxes, please visit https://smartpay.gsa.gov/smarttax. If your state exempts taxes for federal travelers, do not assess taxes! 
