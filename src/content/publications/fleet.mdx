...
order: 3
intro: "Here is the publication that applies to the GSA SmartPay® Fleet business line. For those interested in hard copies of select publications, GSA’s Centralized Mailing List Service (CMLS) provides printing and shipping at no cost to agency customers."
...
| ---------------------------------| ------------------| ----------------| -------------------------|
|[Helpful Hints for Fleet Account Use [PDF, 10 pages]](/files/publications/publications-helpful-hints-for-fleet.pdf)|Card-sized brochure provides dos and don'ts for fleet account card/account holders.|Card/account holders|05-21-00958|
