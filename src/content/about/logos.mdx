---
title: GSA SmartPay Brand Logos and Card Designs
pageTitle: Logos and Designs
description: GSA SmartPay brand logos and card designs. These images may be referenced to indicate an agency’s use or a merchant’s acceptance of GSA SmartPay® solutions.
intro: "These images may be referenced to indicate an agency’s use or a merchant’s acceptance of GSA SmartPay® solutions."
order: 5
category: about
tags:
  - brand
...
<table class="usa-table usa-table--borderless" role="table">
  ...
  <tbody>
    <tr>
      ...
      <td>
        <img
          width="80"
          height="31"
          src="/images/gsa-smartpay-logo_thumb.svg"
          alt="GSA SmartPay Logo with GSA star logo, SmartPay, and Supporting your mission"
        />
      </td>
      <td>
        <a href="/files/gsa-smartpay-program-logo.zip">Download ZIP file</a>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <img
          width="80"
          height="52"
          src="/images/blue-card_thumb.png"
      ...
      <td>
        <a href="/files/gsa-smartpay-travel-card-design.zip">
          Download ZIP file
        </a>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <a href="/files/gsa-smartpay-purchase-card-design.zip">
          Download ZIP file
        </a>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <img
          width="80"
          height="52"
          src="/images/green-card_thumb.png"
      ...
      <td>
        <a href="/files/gsa-smartpay-fleet-card-design.zip">
          Download ZIP file
        </a>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <img
          width="80"
          height="52"
          src="/images/yellow-card_thumb.png"
      ...
      <td>
        <a href="/files/gsa-smartpay-integrated-card-design.zip">
          Download ZIP file
        </a>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <img
          width="80"
          height="52"
          src="/images/silver-card_thumb.png"
          alt="Silver charge card with the words Tax advantage and numbers 1234 5678 9012 3456 and the name John Smith, with a car and buildings in the background"
        />
      </td>
      <td>
        <a href="/files/gsa-smartpay-tax-advantage-card-design.zip">
          Download ZIP file
        </a>
      </td>
    </tr>
