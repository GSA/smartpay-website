...
Opportunities to earn refunds that can directly fund and support mission-critical efforts

[Learn more about refunds](refunds/)
...
- [GSA SmartPay Purchase Card Statistics Report for FPDS (xlsx)](../assets/files/purchase-report.xlsx)
...
- [Sales, Transactions, and Account Holder Data (FY 2009–September 2022)](../assets/files/stats-tool.xlsx) – Spreadsheets containing current statistics for GSA SmartPay Purchase, Travel and Fleet.  Note: For questions about usage of the tool and underlying data, refer to the "Frequently Asked Questions" tab.
- [Fiscal Years 1999–2009 Card Sales, Transactions and Account Holder Data](../assets/files/fy99-09-card-sales-transactions-cardholder-data.xls) – Spreadsheets containing fiscal years 1999–2009 data and statistics for GSA SmartPay Purchase, Travel and Fleet.
