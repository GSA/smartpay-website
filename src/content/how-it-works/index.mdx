...
<ol class="usa-process-list">
  <li class="usa-process-list__item">
    ...
    <p class="margin-top-05">
      A card/account holder uses a GSA SmartPay solution as a method of procurement and payment for the authorized purchase of goods and services.
    </p>
  </li>
  <li class="usa-process-list__item">
  ...
  <li class="usa-process-list__item">
    ...
    <p>
      The issuing bank bills the card/account holder for the full amount of the goods and/or services purchased.
    </p>  
  </li>
</ol>
