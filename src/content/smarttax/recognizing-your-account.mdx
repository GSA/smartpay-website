...
The most reliable way to identify GSA SmartPay Purchase and Fleet charge cards/accounts is through the four digit bank identification number (BIN). In order to recognize GSA SmartPay Travel, Tax Advantage Travel, and Integrated cards/accounts, please refer to the six-digit BIN.
